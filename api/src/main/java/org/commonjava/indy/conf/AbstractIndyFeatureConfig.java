...
/**
 * Abstract implementation of {@link IndyFeatureConfig} that injects the {@link IndyConfigFactory} and implements a protected getConfig()
 ...
 */
public abstract class AbstractIndyFeatureConfig<T, U extends T>
    implements IndyFeatureConfig
{
    ...
    public AbstractIndyFeatureConfig( final Class<U> implCls )
    {
        this.implCls = implCls;
        this.impl = null;
    }

    public AbstractIndyFeatureConfig( final T impl )
    {
        this.implCls = null;
        this.impl = impl;
    }
    ...
    /* (non-Javadoc)
     * @see org.commonjava.indy.conf.IndyFeatureConfig#getInfo()
     */
    @Override
