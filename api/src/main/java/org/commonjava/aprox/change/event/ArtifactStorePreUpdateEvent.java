    ...
    extends ArtifactStoreUpdateEvent
{
    ...
    public ArtifactStorePreUpdateEvent( final ArtifactStoreUpdateType type, final Collection<ArtifactStore> changes )
    {
        super( type, changes );
    }

    public ArtifactStorePreUpdateEvent( final ArtifactStoreUpdateType type, final ArtifactStore... changes )
    {
        super( type, changes );
    }
}
