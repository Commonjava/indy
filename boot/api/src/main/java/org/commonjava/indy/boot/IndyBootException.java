 ...
 */
public class IndyBootException
    extends Exception
{
    ...
    public IndyBootException( final String message, final Object... params )
    {
        super( message );
        this.params = params;
    }

    public IndyBootException( final String message, final Throwable cause, final Object... params )
    {
        super( message, cause );
        this.params = params;
    }
