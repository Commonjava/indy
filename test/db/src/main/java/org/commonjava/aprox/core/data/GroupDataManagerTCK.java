    ...
    extends AbstractProxyDataManagerTCK
{
        ...
        throws ProxyDataException
    {
        ...
        final Group grp = new Group( "test", new StoreKey( StoreType.repository, "central" ), new StoreKey( StoreType.repository, "repo2" ) );
        ...
        throws ProxyDataException
    {
        ...
        final Group grp = new Group( "test", new StoreKey( StoreType.repository, "repo2" ), new StoreKey( StoreType.repository, "central" ) );
