...
indy.config(['$routeProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide',
  ...
  $routeProvider.when('/remote/:packageType/new', {templateUrl: 'partials/remote-edit.html'});
  ...
  $routeProvider.when('/hosted/:packageType/new', {templateUrl: 'partials/hosted-edit.html'});
  ...
  $routeProvider.when('/group/:packageType/new', {templateUrl: 'partials/group-edit.html'});
