 ...
 */
package org.commonjava.indy.subsys.metrics.zabbix.sender;

import org.commonjava.indy.IndyException;
import org.commonjava.o11yphant.metrics.exception.MetricsException;
import org.commonjava.indy.subsys.metrics.zabbix.api.IndyZabbixApi;
import org.commonjava.indy.subsys.metrics.zabbix.api.ZabbixApi;
...
public class IndyZabbixSender
{
    ...
    String checkHostGroup( String hostGroup ) throws IOException, IndyHttpException, MetricsException
    {
    ...
    String checkHost( String host, String ip ) throws IOException, IndyHttpException, MetricsException
    {
        try
        {
    ...
    String checkItem( String host, String item, int valueType ) throws IOException, IndyHttpException, MetricsException
    {
    ...
    public SenderResult send( DataObject dataObject ) throws IOException, IndyException, MetricsException
    {
        return this.send( dataObject, System.currentTimeMillis() / 1000L );
    }

    public SenderResult send( DataObject dataObject, long clock )
                    throws IOException, IndyException, MetricsException
    {
        return this.send( Collections.singletonList( dataObject ), clock );
    }

    public SenderResult send( List<DataObject> dataObjectList ) throws IOException, IndyException, MetricsException
    {
    ...
    public SenderResult send( List<DataObject> dataObjectList, long clock )
                    throws IOException, IndyHttpException, MetricsException
    {
    ...
    private void zabbixApiInit() throws MetricsException, IOException, IndyHttpException
    {
        if ( !bCreateNotExistZabbixApi )
        {
            return;
        ...
        {
            throw new MetricsException( "can not find Zabbix's Host" );
        }
        ...
        if ( this.zabbixUserName == null || "".equals( this.zabbixUserName ) || this.zabbixUserPwd == null || "".equals(
                        this.zabbixUserPwd ) )
        {
            throw new MetricsException( "can not find Zabbix's username or password" );
        }
