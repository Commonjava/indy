 ...
 *     <li>Hosted repo C is appended to the membership of X just ahead of D</li>
 * </ul>
 *
 * THEN:
 * <ul>
 ...
 *
 */
public class GroupMetadataMergeWhenSeqNewHostedAddedInMultiHostedGroupTest
        extends AbstractContentManagementTest
{
            ...
            throws Exception
    {
        ...
        g.setConstituents( constituents );

        client.stores().update( g, "test update" );
        g = client.stores().load( StoreType.group, g.getName(), Group.class  );
        logger.debug( "\n\nGroup constituents are:\n  {}\n\n", StringUtils.join( g.getConstituents(), "\n  " ) );
