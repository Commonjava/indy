    ...
    implements BootupAction, ShutdownAction
{
        ...
        throws IndyLifecycleException
    {
        ...
        if ( violations != null )
        {
            throw new IndyLifecycleException( "Scheduler configuration is not valid:\n%s", violations );
        }
        ...
        if ( ddlFile.exists() )
        {
            ...
            {
                throw new IndyLifecycleException( "Failed to read DDL from file: " + ddl, e );
            }
        }
        ...
        if ( lines == null )
        {
            ...
            if ( resource != null )
            {
                ...
                {
                    throw new IndyLifecycleException( "Failed to read DDL from classpath: " + ddl, e );
                }
            }
        }
        ...
        if ( lines != null )
        {
            ...
            {
                throw new IndyLifecycleException( "Failed to load database driver: " + driverName, e );
            }
            ...
            {
                throw new IndyLifecycleException( "Failed to connect to database: " + url, e );
            }
            ...
            {
                throw new IndyLifecycleException( "Failed to modify database for scheduler: " + url, e );
            }
            finally
            {
        ...
        throws IndyLifecycleException
    {
        ...
        if ( dbDriver.startsWith( APACHEDB_DRIVER_SUPER_PACKAGE ) )
        {
            ...
            {
                throw new IndyLifecycleException( "Failed to load database driver: " + dbDriver, e );
            }
            catch ( final SQLException e )
            {
                logger.debug( e.getMessage(), e );
