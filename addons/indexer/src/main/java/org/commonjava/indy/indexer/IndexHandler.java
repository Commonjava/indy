...
public class IndexHandler
{
    ...
    private IndexUpdateResult doIndexUpdate( final IndexingContext mergedContext, final StoreKey key )
    {
        try
        {
            final ResourceFetcher resourceFetcher = new IndyResourceFetcher( storeDataManager, fileManager );
    ...
    private IndexingContext getIndexingContext( final ArtifactStore store, final List<IndexCreator> indexers )
    {
        ...
        try
        {
            ...
            at org.commonjava.indy.indexer.IndexHandler.getIndexingContext(IndexHandler.java:442) [classes:]
            at org.commonjava.indy.indexer.IndexHandler.getContextsFor(IndexHandler.java:411) [classes:]
            at org.commonjava.indy.indexer.IndexHandler.updateMergedIndex(IndexHandler.java:264) [classes:]
            at org.commonjava.indy.indexer.IndexHandler.access$300(IndexHandler.java:57) [classes:]
            at org.commonjava.indy.indexer.IndexHandler$AdditionRunnable.run(IndexHandler.java:578) [classes:]
