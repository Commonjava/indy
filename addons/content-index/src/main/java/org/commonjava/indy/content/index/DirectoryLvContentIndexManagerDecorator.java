        ...
        implements ContentIndexManager
{
    ...
    {
        logger.debug( "DECORATED removeIndexedStorePath:(path {}, key {})", path, key );
    ...
    {
        logger.debug( "DECORATED deIndexStorePath:(path {}, key {})", path, key );
    ...
    {
        logger.debug( "DECORATED indexTransferIn:(transfer path {}, topKeys {})", transfer.getPath(), topKeys );
    ...
    {
        logger.debug( "DECORATED indexPathInStores:(path {}, originKey {},  topKeys {})", path, originKey, topKeys );
    ...
    {
        logger.debug( "DECORATED clearIndexedPathFrom:(path {}, groups {})", path, groups );
