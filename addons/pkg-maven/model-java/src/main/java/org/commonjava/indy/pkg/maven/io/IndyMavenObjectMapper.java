 ...
 */
package org.commonjava.indy.pkg.maven.io;
...
import org.commonjava.indy.model.core.io.ApiSerializerModule;
import org.commonjava.indy.model.core.io.IndySerializationException;
import org.commonjava.indy.model.core.io.ModuleSet;
import org.commonjava.indy.pkg.maven.IndyMavenSerializerModule;
...
@Alternative
@Named
public class IndyMavenObjectMapper
        extends ObjectMapper
{
    ...
    protected IndyMavenObjectMapper()
    {
        ctorModules = null;
        ctorModuleSets = null;
    }

    public IndyMavenObjectMapper( final boolean unused, final Module... additionalModules )
    {
    ...
    public IndyMavenObjectMapper( final Iterable<Module> modules )
    {
        final Set<Module> mods = new HashSet<Module>();
    ...
    public IndyMavenObjectMapper( Instance<Module> modules, Instance<ModuleSet> moduleSets )
    {
        final Set<Module> mods = new HashSet<Module>();
        mods.add( new ApiSerializerModule() );
        mods.add( new ProjectVersionRefSerializerModule() );
    ...
    private void injectSingle( Module module )
    {
        ...
        if ( module instanceof IndyMavenSerializerModule )
        {
            ( (IndyMavenSerializerModule) module ).register( this );
        }
    }
