 ...
 */
public class NoVersionRanges_DependencyVersion_RuleTest
        extends AbstractValidationRuleTest<Group>
{
            ...
            throws Exception
    {
        ...
        deploy( invalid, "<?xml version=\"1.0\"?>\n<project><modelVersion>4.0.0</modelVersion><groupId>org.foo</groupId>"
                ...
                + "<version>[1.0,1.1]</version></dependency></dependencies></project>" );
    ...
    public NoVersionRanges_DependencyVersion_RuleTest()
    {
        super( Group.class );
    }
