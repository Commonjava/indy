...
public class RenderingController
{
        ...
        throws IndyWorkflowException
    {
        ...
        {
            throw new IndyWorkflowException( "Failed to serialize to JSON: %s", e, e.getMessage() );
        }
        ...
        {
            throw new IndyWorkflowException( "Failed to generate dependency tree. Reason: {}", e, e.getMessage() );
        }
        ...
        {
            throw new IndyWorkflowException( "Failed to open work file for caching output: {}. Reason: {}", e, out,
                                              e.getMessage() );
        }
        finally
        {
        ...
        throws IndyWorkflowException
    {
        ...
        {
            throw new IndyWorkflowException( ApplicationStatus.BAD_REQUEST.code(), "Failed to render POM: {}", e,
                                              e.getMessage() );
        }
        catch ( final CartoDataException e )
        {
        ...
        throws IndyWorkflowException
    {
        ...
        {
            throw new IndyWorkflowException( "Failed to render Graphviz dotfile for: %s. Reason: %s", e, recipe,
                                              e.getMessage() );
        }
        catch ( CartoRequestException e )
        {
