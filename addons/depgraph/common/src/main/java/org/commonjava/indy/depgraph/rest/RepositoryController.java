...
import org.commonjava.indy.depgraph.model.*;
...
public class RepositoryController
{
                    ...
                    throws IndyWorkflowException
    {
        ...
        {
            throw new IndyWorkflowException( "Failed to generate runtime repository. Reason: {}", e, e.getMessage() );
        }
        finally
        {
            closeQuietly( stream );
                    ...
                    throws IndyWorkflowException
    {
        ...
        catch ( final CartoDataException e )
        {
            logger.error( String.format( "Failed to graph repository contents for: %s. Reason: %s", recipe,
                                         e.getMessage() ), e );
            throw new IndyWorkflowException( "Failed to graph repository contents for: {}. Reason: {}", e, recipe,
                                              e.getMessage() );
        }
        catch ( CartoRequestException e )
        {
            throw new IndyWorkflowException( ApplicationStatus.BAD_REQUEST.code(), "Invalid request: %s. Reason: %s",
                    ...
                    throws IndyWorkflowException
    {
        ...
        else
        {
            ...
            {
                throw new IndyWorkflowException( "Failed to generate remote URL for: %s in location: %s. Reason: %s",
