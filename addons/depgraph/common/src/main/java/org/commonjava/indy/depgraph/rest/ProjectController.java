...
public class ProjectController
{
        ...
        throws IndyWorkflowException
    {
        ...
        {
            throw new IndyWorkflowException( "Failed to lookup project listing matching request: %s. Reason: %s", e,
                                              recipe, e.getMessage() );
        }
        ...
        throws IndyWorkflowException
    {
        ...
        {
            throw new IndyWorkflowException( "Failed to lookup parent(s) for request: %s. Reason: %s", e, recipe,
                                              e.getMessage() );
        }
        catch ( CartoRequestException e )
        {
