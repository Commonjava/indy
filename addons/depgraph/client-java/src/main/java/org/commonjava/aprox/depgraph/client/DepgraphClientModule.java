                ...
                extends AproxClientModule
{
    ...
    public MappedProjectRelationshipsResult relationshipsTargeting( ProjectGraphRelationshipsRequest request )
                    throws AproxClientException
    {
        return getHttp().postWithResponse( "depgraph/project/targeting", request, MappedProjectRelationshipsResult.class );
    }
                    ...
                    throws AproxClientException
    {
        ...
        if ( params != null && !params.containsKey( "name" ) && !params.containsKey( "coord" ) )
        {
            ...
            logger.warn("You have not specified a 'name' or 'coord' parameter to be used in naming your Graphviz dotfile!");
        }
    ...
    public String depTree( RepositoryContentRequest request )
                    throws AproxClientException
    {
        return postWithStringOutput( "depgraph/render/tree", request );
    }
