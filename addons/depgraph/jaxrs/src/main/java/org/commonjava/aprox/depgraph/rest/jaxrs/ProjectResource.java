...
public class ProjectResource
{
    ...
    public Response errors( @PathParam( "g" ) final String groupId, @PathParam( "a" ) final String artifactId, @PathParam( "v" ) final String version )
    {
        ...
        {
            logger.error( "Failed to lookup errors for: %s. Reason: %s", e, ref == null ? "all projects" : ref, e.getMessage() );
                              ...
                              @PathParam( "v" ) final String version )
    {
        ...
        {
            logger.error( "Failed to lookup parent for: %s:%s:%s. Reason: %s", e, groupId, artifactId, version, e.getMessage() );
                                    ...
                                    @PathParam( "v" ) final String version, @QueryParam( "scopes" ) final String scopesStr )
    {
                                           ...
                                           .length() > 0 )
        {
            ...
            final Set<DependencyScope> ds = new HashSet<DependencyScope>( scopes.length );
        ...
        {
            logger.error( "Failed to lookup dependencies for: %s:%s:%s. Reason: %s", e, groupId, artifactId, version, e.getMessage() );
                               ...
                               @PathParam( "v" ) final String version )
    {
        ...
        {
            logger.error( "Failed to lookup plugins for: %s:%s:%s. Reason: %s", e, groupId, artifactId, version, e.getMessage() );
                                  ...
                                  @PathParam( "v" ) final String version )
    {
        ...
        {
            logger.error( "Failed to lookup extensions for: %s:%s:%s. Reason: %s", e, groupId, artifactId, version, e.getMessage() );
                                              ...
                                              @PathParam( "v" ) final String version, @Context final HttpServletRequest request )
    {
        ...
        {
            logger.error( "Failed to lookup relationships specified by: %s:%s:%s. Reason: %s", e, groupId, artifactId, version, e.getMessage() );
